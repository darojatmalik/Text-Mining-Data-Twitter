# 
# library(dplyr)
# #datatwitter1 <- read.csv("data/datafinal3.csv")
# saveRDS(datatwitter, file = "data/datatwitter.rds")
# #allzips <- readRDS("data/superzip.rds")
# #allzips <- read.csv("data/superzip.csv")
# allzips <- readRDS("data/datatwitter.rds")
# allzips$latitude <- jitter(allzips$latitude)
# allzips$longitude <- jitter(allzips$longitude)
# #allzips$college <- allzips$college * 100
# #allzips$zipcode <- formatC(allzips$zipcode, width=5, format="d", flag="0")
# #row.names(allzips) <- allzips$zipcode
# allzips$id <- allzips$doc_id
# row.names(allzips) <- allzips$id
# cleantable <- allzips %>%
# select(
#    username = username,
#    tgl = date,
...
praproses <- function(datatwitter){
  print(datatwitter)
  ...
  #write.csv(df_total, file="data/datafinal3.csv")
}
